...
#ifndef __ICM_42688_P_SPI_H
#define __ICM_42688_P_SPI_H
...
#define AODR_32000Hz  0x01
#define AODR_16000Hz  0x02
...
#define GODR_32000Hz  0x01
#define GODR_16000Hz  0x02
...
int8_t bsp_IcmGetTemperature(int16_t* pTemp, SPI_HandleTypeDef* hspi);
...
void attiget(icm42688RawData_t* GyroData, SPI_HandleTypeDef* hspi);
int8_t bsp_IcmGetRawData(icm42688RawData_t* accData, icm42688RawData_t* GyroData, SPI_HandleTypeDef* hspi);
int8_t RawData(icm42688RawData_t* accData, icm42688RawData_t* GyroData);
void CS_INIT(void);

#define SPI_IMU_CS_LOW()  HAL_GPIO_WritePin(GPIOA, GPIO_PIN_15, GPIO_PIN_RESET)  
#define SPI_IMU_CS_HIGH() HAL_GPIO_WritePin(GPIOA, GPIO_PIN_15, GPIO_PIN_SET)

#endif /* __ICM_42688_P_SPI_H__ */
